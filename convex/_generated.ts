...
import type { queryRound_default as _deps_5RU6INIK__queryRound_default } from "./_deps/5RU6INIK";
...
import type leaveGame from "./leaveGame";
...
export type ConvexAPI = {
  queries: {
    "_deps/5RU6INIK:queryRound_default": ClientQuery<typeof _deps_5RU6INIK__queryRound_default>;
  ...
  mutations: {
    ...
    leaveGame: ClientMutation<typeof leaveGame>;
    ping: ClientMutation<typeof ping>;
    purgeAbandoned: ClientMutation<typeof purgeAbandoned>;
